...
# msc = Label(tab1, text="Music Goes Here", font=("roboto", 50))
# # msc.pack(padx=20, pady=20)
# msc.grid(column=0, row=0)
#
#
# style = ttk.Style()
#
...
#
# maps = Label(tab1, text="maps info here", font=('monsterrat', 50))
# maps.grid(column=6, row=0)
# map_frame = ttk.Frame(tab2)
# map_frame['padding'] = 5
# map_frame['borderwidth'] = 2
# map_frame['relief'] = 'sunken'
# map_frame.grid(column=6, row=6)
#
